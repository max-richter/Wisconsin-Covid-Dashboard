...
class InfoSection extends React.Component {
  render() {
    return (
      <div className="row justify-content-center row-styled footer-container">
          ...
          <div className="card grid-card">
            ...
            <div className="card-value">
              <span className="card-text-style">
                ...
                <hr></hr>
                <ul><a href="https://www.dhs.wisconsin.gov/covid-19/community-testing.htm" target="_blank">
                  Find your local testing site</a><GrLink className="link-icon-style" size="1.5rem"/></ul>
                <hr></hr>
                <ul><a href="https://www.wihealthconnect.com/" target="_blank">
                  Free COVID-19 Self-Assessment</a><GrLink className="link-icon-style" size="1.5rem"/></ul>
                <hr></hr>
                <ul><a href="https://data.dhsgis.wi.gov/datasets/covid-19-historical-data-table/data?where=GEO%20%3D%20%27State%27" target="_blank">
                  State Data</a><GrLink className="link-icon-style" size="1.5rem"/></ul>
                <hr></hr>
                <ul><a href="https://data.dhsgis.wi.gov/datasets/covid-19-historical-data-table/data?where=GEO%20%3D%20%27County%27" target="_blank">
